...
int main() {
//cons_printf("calling init daata\n");	
InitData(); // to initialize kernel data
//cons_printf("calling create isr\n");
CreateISR(0); //to create Idle process (PID 0)
//cons_printf("calling init idt\n");
InitIDT();

//cons_printf("calling disptach\n");
Dispatch(pcb[0].TF_ptr);
//cons_printf("end of main\n");


	//CRP=0;
 /*	while(1) { //(alter between 2 things)
